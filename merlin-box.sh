...
#=========================================
# 生成开机启动脚本 & 将 当前脚本放在 /jffs/scripts/services-start 中以便开机启动
#=========================================
install() {
  ...
  # 梅林固件的标准服务启动脚本
  local merlin_services_start="/jffs/scripts/services-start"
...
#=========================================
# 卸载开机启动脚本 & 删除 /jffs/scripts/services-start 中的
#=========================================
uninstall() {
  ...
  # A. 从 /jffs/scripts/services-start 中删除对应行
  if [ -f "${merlin_services_start}" ]; then
    echo "Removing boot line from merlin services-start"
