...
func startHTTPServer(port int) {
	...
	router.Post("/api/delay", handlers.Delay)
	router.Post("/api/remote_version", handlers.RemoteVersion)
	router.Post("/api/update", handlers.Update)
	...
	router.Post("/api/restart_ui", handlers.RestartUI)
	...
	router.Post("/api/save_node", handlers.SaveNode)
